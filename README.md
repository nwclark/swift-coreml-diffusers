...
Many thanks to the developers of the original [Huggingface project](https://github.com/huggingface/swift-coreml-diffusers) from which this project was forked.
